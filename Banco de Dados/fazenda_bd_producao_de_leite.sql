...
CREATE TABLE `producao_de_leite` (
  ...
  `ultima_ordenha` date DEFAULT NULL,
  `temperatura_do_leite` float NOT NULL,
  `produtividade_em_litros` float DEFAULT NULL,
  `inseminacao` enum('Sim','Não') DEFAULT NULL,
  `estimativa_parto` date DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `producao_de_leite` VALUES (1,'Vaca Malhada','2022-06-07',17,10.79,'Sim','2023-06-08');
